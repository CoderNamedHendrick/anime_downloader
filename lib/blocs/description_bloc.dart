...
class DescriptionBloc{
  ...
  StreamSink<ApiResponse<DescriptionModel>> get descriptionSink => _descriptionController.sink;

  Stream<ApiResponse<DescriptionModel>> get descriptionStream => _descriptionController.stream;
